...
public class Solution {
    ...
    public <T extends Item> T getProxy(Class<T> item, Class<?> ...appInterfaces){
        ClassLoader classLoader = item.getClassLoader();
        Class<?>[] interfaces = new Class[appInterfaces.length+1];
        System.arraycopy(appInterfaces, 0, interfaces, 0, appInterfaces.length);
        interfaces[interfaces.length - 1] = item;
