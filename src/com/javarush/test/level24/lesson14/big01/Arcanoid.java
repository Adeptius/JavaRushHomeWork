...
public class Arcanoid
{
    ...
    public void checkBricksBump()
    {
        ...
        for (int i = 0; i < bricks.size(); i++) {
            if (bricks.get(i).isIntersec(ball)){
                bricks.remove(i);
    ...
    public void checkStandBump()
    {
        ...
        if (ball.isIntersec(stand)) ball.setDirection(30+(Math.random()*70));
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        game.getBricks().add(new Brick(3, 8));
        game.getBricks().add(new Brick(16, 8));
        game.getBricks().add(new Brick(10, 1));
