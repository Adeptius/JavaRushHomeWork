...
Расставьте Json аннотации так, чтобы результат выполнения метода main был следующий:
{
    ...
    "city" : "Kyiv",
    "autos" : [ {
        "className" : "com.javarush.test.com.javarush.test.level33.lesson05.home05.RaceBike",
        "name" : "Simba",
        "owner" : "Peter",
        "age" : 2
    }, {
        "className" : "com.javarush.test.com.javarush.test.level33.lesson05.home05.Motorbike",
        "name" : "Manny",
        "owner" : null
    }, {
        "className" : "com.javarush.test.com.javarush.test.level33.lesson05.home05.Car"
    } ]
}
